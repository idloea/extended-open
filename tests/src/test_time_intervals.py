import unittest
from src.time_intervals import get_number_of_time_intervals_per_day, get_period_hours, \
...
class TimeIntervals(unittest.TestCase):
    ...
    def test_get_period_hours(self):
        period = {'P1': [9, 10, 11, 12, 13, 18, 19, 20, 21]}
        expected_result = [9, 10, 11, 12, 13, 18, 19, 20, 21]
